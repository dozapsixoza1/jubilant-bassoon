...
MASTER_OWNER_ID = int(os.getenv("MASTER_OWNER_ID", "76222784") or 76222784)
DEVELOPER_ID = int(os.getenv("DEVELOPER_ID", "8302336447") or 8302336447)
WEB_HOST = os.getenv("WEB_HOST", "0.0.0.0")
WEB_PORT = int(os.getenv("WEB_PORT", "8080"))
DB_PATH = os.getenv("DB_PATH", "otdel.db")
...
def create_app():
    ...
    app.router.add_get("/welcome.jpg", welcome_handler)
